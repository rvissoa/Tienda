    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarritoCompraId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Distrito = table.Column<string>(maxLength: 10, nullable: true),
                    Email = table.Column<string>(maxLength: 50, nullable: false),
                    Nombres = table.Column<string>(maxLength: 50, nullable: false),
                    OrdenColocada = table.Column<DateTime>(nullable: false),
                    OrdenTotal = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagenMiniatura = table.Column<string>(nullable: true),
                    ImagenUrl = table.Column<string>(nullable: true),
                    Nombre = table.Column<string>(nullable: true),
                    Precio = table.Column<decimal>(nullable: false),
                    Preferidos = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ItemsCarritoCompra",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Cantidad = table.Column<int>(nullable: false),
                    CarritoCompraId = table.Column<string>(nullable: true),
                    ProductoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsCarritoCompra", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsCarritoCompra_CarritoCompra_CarritoCompraId",
                        column: x => x.CarritoCompraId,
                        principalTable: "CarritoCompra",
                        principalColumn: "CarritoCompraId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemsCarritoCompra_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsCarritoCompra_CarritoCompraId",
                table: "ItemsCarritoCompra",
                column: "CarritoCompraId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsCarritoCompra_ProductoId",
                table: "ItemsCarritoCompra",
                column: "ProductoId");
